...
// Canonical list for pattern metafield
const ALLOWED_TAGS = [
  "Animals", "Birds", "Brick", "Damask", "Floral", "Geometric",
  "Mural", "Plaid", "Stripes", "Tiles", "Trees", "Watercolor", "Wood"
];
        ...
        products(first: 100, after: $cursor) {
          ...
          edges {
            ...
            node {
              id
              tags
              metafield(namespace: "custom", key: "pattern") {
                id
                value
              }
            }
